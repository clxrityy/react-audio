...
if (!HTMLMediaElement.prototype.load || !stubbed.has(HTMLMediaElement.prototype.load)) {
  const stub = vi.fn();
...
if (!HTMLCanvasElement.prototype.getContext || !stubbed.has(HTMLCanvasElement.prototype.getContext as unknown as AnyFn)) {
...
// Audio methods
if (!HTMLMediaElement.prototype.play || !stubbed.has(HTMLMediaElement.prototype.play)) {
...
if (!HTMLMediaElement.prototype.pause || !stubbed.has(HTMLMediaElement.prototype.pause)) {
  const stub = vi.fn();
