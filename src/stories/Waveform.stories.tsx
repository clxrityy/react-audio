...
export const CustomColor = () => <Waveform track={track} color="#ff0000" />
export const LowerFFTSize = () => <Waveform track={track} fftSize={128} />
export const HigherFFTSize = () => <Waveform track={track} fftSize={16384} />
